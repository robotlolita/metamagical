...
#### [`get allowInheritance`](documentation/allowInheritance)
...
#### [`get allowPropagation`](documentation/allowPropagation)
...
#### [`merge(values)`](documentation/merge)
...
#### [`.toString()`](documentation/toString)
...
#### [`.refine(properties)`](documentation/refine)
