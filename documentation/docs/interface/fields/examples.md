...
#### [`get allowInheritance`](examples/allowInheritance)
...
#### [`get allowPropagation`](examples/allowPropagation)
...
#### [`.refine(properties)`](examples/refine)
