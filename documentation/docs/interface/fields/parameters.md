...
#### [`get allowInheritance`](parameters/allowInheritance)
...
#### [`get allowPropagation`](parameters/allowPropagation)
...
#### [`.refine(properties)`](parameters/refine)
